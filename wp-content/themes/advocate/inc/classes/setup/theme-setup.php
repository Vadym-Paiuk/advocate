...
class Theme_Setup {
	...
	public function register_menus() {
		register_nav_menus( array(
			...
			'footer-menu'            => esc_html__( 'Footer Menu 1' ),
		) );
	}
	...
	public function enqueue_style() {
		wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/assets/dist/fonts/FontAwesome/css/all.css', array(), THEME_VERSION );
